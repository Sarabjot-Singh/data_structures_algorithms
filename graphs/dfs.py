...
class Solution:
    ...
    def dfsUtil(self, adj, node, visited, dfs_traversal):
        visited[node] = 1
        dfs_traversal.append(node)

        for vertex in adj[node]:
            if not visited[vertex]:
                self.dfsUtil(adj, vertex, visited, dfs_traversal)
    ...
    def dfs(self, adj):
        ...
        self.dfsUtil(adj, 0, visited, dfs_traversal)
        return dfs_traversal
